...
import calculateAPY from '../Components/calculateAPY';
import learningScreen from '../Components/learningScreen';
import global from '../Components/global';
import {In,ADT,ST,HNS,DT,TT,BP,BR,RW} from '../LearningComponents/Intro';
import Header from '../Components/header';
import Detailed from '../Components/detailedCrypto';
...
const HomeNav = ({navigation}) =>{
    ...
    <StackHome.Navigator
        ...
        <StackHome.Screen name="Home" component={Home} options={{headerTitle:()=> <Header navigation={navigation}/>}}/>
        <StackHome.Screen name="detailed" component={Detailed} options={({ route }) => ({ headerTitle:()=><View><Text style={{fontSize:24,fontWeight:'bold'}}>{route.params.name}</Text></View>})}/>
    </StackHome.Navigator>
    );
}
...
const StackCalculator=({navigation}) =>{
    return(
    <StackAPY.Navigator>
        <StackAPY.Screen name="Yield Calculator" component={calculateAPY} options={{headerTitle:()=><SecondHeader name="APY Calculator"/>}}/>
    </StackAPY.Navigator>
    )
}
...
const StackGlobal=({navigation}) =>{
    return(
    <StackAPY.Navigator>
        <StackAPY.Screen name="Global" component={global} options={{headerTitle:()=><SecondHeader name="Coin Gecko Info"/>}}/>
    </StackAPY.Navigator>
    )
}
...
const StackLearning=({navigation})=>{
    ...
    screenOptions={{
      cardStyleInterpolator: CardStyleInterpolators.forHorizontalIOS
        ...
        <stackLearn.Screen name="Learning Screen" navigation={navigation} component={learningScreen} options={{headerTitle:()=><SecondHeader name="Become an Investor"/>}}/>
...
const StackNav= ({navigation}) =>{
    return(
        <StackNews.Navigator>
            <StackNews.Screen name="News" component={News}  options={{headerTitle:()=><SecondHeader name="News"/>}} />
        </StackNews.Navigator>
    )
}
